...
class CarBrandInfo(models.Model):
    car_brand = models.CharField(max_length=50, unique=True, verbose_name=u'汽车品牌')
...
class CarSeriesInfo(models.Model):
    ...
    car_series = models.CharField(max_length=100, unique=True, verbose_name=u'车系')
...
class CarModelInfo(models.Model):
    ...
    car_model = models.CharField(max_length=100, verbose_name=u'车型')
...
class CarInfo(models.Model):
    ...
    car_brand = models.CharField(max_length=50, null=True, blank=True, verbose_name=u'汽车品牌')
    car_name = models.CharField(max_length=10, default=u'我的小车', verbose_name=u'汽车昵称')
    car_series = models.CharField(max_length=100, null=True, blank=True, verbose_name=u'车系')
    car_model = models.CharField(max_length=100, null=True, blank=True, verbose_name=u'车型')
